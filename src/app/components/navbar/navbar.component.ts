...
import { MenuConfig } from 'app/_config/menu.config';
...
export class NavbarComponent implements OnInit {
    ...
    ngOnInit() {
        this.listTitles = this.menuConfig.menu.filter(listTitle => listTitle);
